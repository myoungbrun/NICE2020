...
\begin{longtable}{|p{1.5in}|p{2.5in}|p{0.9in}|p{0.7in}|}
  ...
  \(\text{list\_llmic\_flag[c]}\) & Equal to 1 if the country is on the list of low and middle income countries, 0 otherwise & — & — \\
  \(\text{list\_risk\_index[c]}\) & Risk index & — & — \\
  ...
  \(\text{mapcrrice[c]}\) & Mapping from country index to RICE region index & — &183 countries to 12 regions \\
